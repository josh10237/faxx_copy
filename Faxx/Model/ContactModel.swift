...
class ContactModel: NSObject {
    ...
    func getJSON() -> [String : Any] {
        return [
            ...
            "f_avatar": f_avatar,
            "f_fcm_token": f_fcm_token,
            "f_anon_display_name": f_anon_display_name,
            "f_anon_avatar": f_anon_avatar,
            "t_id": t_id,
            "t_display_name": t_display_name,
            "t_avatar": t_avatar,
            "t_fcm_token": t_fcm_token,
            "t_anon_display_name": t_anon_display_name,
            "t_anon_avatar": t_anon_avatar,
